...
class PrinterHeaters:
    def __init__(self, config):
        ...
        gcode.register_command("WAIT_TEMPERATURE", self.cmd_WAIT_TEMPERATURE,
                               desc=self.cmd_WAIT_TEMPERATURE_help)
    ...
    cmd_WAIT_TEMPERATURE_help = "Wait for a temperature on a sensor"
    def cmd_WAIT_TEMPERATURE(self, gcmd):
